...
export default function SellerAddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/seller/products'); } catch (err) { const data = err.response?.data; setError(typeof data === 'string' ? data : Object.values(data || {}).flat().join('. ')); } finally { setLoading(false); } };
