...
export default function SellerOrdersPage() {
  ...
  if (!user?.is_seller) {
    return <div className="text-center py-20 text-gray-400">Please login as a seller</div>
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm p-12 text-center text-gray-400">No orders yet</div>
      ) : (
