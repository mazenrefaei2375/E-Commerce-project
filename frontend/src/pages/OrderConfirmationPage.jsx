...
export default function OrderConfirmationPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16 text-center">
      <div className="bg-white rounded-2xl shadow-lg shadow-gray-200 p-10">
        ...
        <div className="flex gap-3 justify-center">
          <Link to={`/orders/${id}`}
            className="bg-blue-800 text-white px-6 py-2.5 rounded-lg hover:bg-blue-900 font-medium">
            View Order
          </Link>
          <Link to="/products"
            className="border border-gray-300 text-gray-800 px-6 py-2.5 rounded-lg hover:bg-stone-50 font-medium">
            Continue Shopping
          </Link>
        </div>
      </div>
